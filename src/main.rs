...
fn main() {
    ...
    while !window.should_close() {
        ...
        // player shadows
        {
            ...
            simple_depth_shader.set_mat4("model", &player_transform);
            ...
            player.borrow_mut().render(&simple_depth_shader);
            ...
            unsafe {
                ...
                gl::ActiveTexture(gl::TEXTURE0 + texture_unit);  // using 10 should work
